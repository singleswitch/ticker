...
class PylabSettings():
    def __init__(self):
        self.params = { 'axes.labelsize':10, 'xtick.labelsize': 10,'ytick.labelsize': 10, 
                'axes.titlesize':10, 'text.usetex': False,  'text_font': 10 }
...
class DispSettings(PylabSettings):
    ...
    def setTexTrue(self):
        ...
        p.rcParams.update(self.params)
        p.rcParams['text.latex.preamble']=[r"\usepackage{amsmath}"]
        
    def setTexFalse(self):
        self.params['text.usetex'] = False
        p.rcParams.update(self.params)
    ...
    def setClickDistributionDisplay1D(self):
        self.params = {'axes.labelsize':17,'xtick.labelsize': 17,'ytick.labelsize': 17,
            'text.usetex': True,'font.size': 17, 'alphabet_size':15 }
        p.rcParams.update(self.params)
        p.rcParams['text.latex.preamble']=[r"\usepackage{amsmath}"]
    ...
    def setClickDistributionDisplay2DTarget(self):
        ...
        self.params = {'axes.labelsize':35,'xtick.labelsize': 35,'ytick.labelsize': 35, 
            'text.usetex': True, 'font.size': 35, 'text_font':30,
            'font.family': 'sans-serif'}
        p.rcParams.update(self.params)
        p.rcParams['text.latex.preamble']=[r"\usepackage{amsmath}"]
        
    def setLetterConfigDisp(self):
        self.params = {'axes.labelsize':12,'xtick.labelsize': 12,'ytick.labelsize': 12, 'text.usetex': True,
                  'font.size': 12}
        p.rcParams.update(self.params)
        p.rcParams['text.latex.preamble']=[r"\usepackage{amsmath}"]

    def setGrid2ProbPlots(self):
        self.params = {'axes.labelsize':40,'xtick.labelsize': 35,'ytick.labelsize': 35, 'text.usetex': False,
                  'font.size': 35}
        p.rcParams.update(self.params)
        
    def setBoxPlotDisp(self):
        self.params = {'axes.labelsize':12,'xtick.labelsize': 12,'ytick.labelsize': 12, 'text.usetex': False,
                  'font.size': 12}
        p.rcParams.update(self.params)
        
    def setClickDataDisp(self):
        self.params = {'axes.labelsize':8,'xtick.labelsize':8,'ytick.labelsize':8, 'text.usetex': False,
                  'font.size': 8}
        p.rcParams.update(self.params) 
        
    def setAudioUserTrialBoxPlotDisp(self): 
        self.params = {'axes.labelsize':12,'xtick.labelsize':12,
            'ytick.labelsize':12, 'text.usetex': False,'font.size': 12}
        p.rcParams.update(self.params) 
    
    def setDrawBinarySequences(self):
        self.params = { 'axes.labelsize':10, 'xtick.labelsize': 10,'ytick.labelsize': 10, 
                'axes.titlesize':10, 'text.usetex': False,  'font.size': 8, 'font.family':'monospace',
                 'font.weight':'bold' }
        p.rcParams.update(self.params) 
    ...
    def setAlphabetConfigDisplay(self):
        """This should be the same as in ticker_click_noise_numerical"""
        self.params = {'axes.labelsize':45,'xtick.labelsize': 40,'ytick.labelsize': 40, 
            'text.usetex': True, 'font.size': 40, 'text_font':40,
    ...
    def setSimulationPlotsDisp(self):
        self.params = {'axes.labelsize':45,'xtick.labelsize': 45,'ytick.labelsize': 45, 'text.usetex': True,
                  'font.size': 45}
        p.rcParams.update(self.params)
        
    def setAudioUserTrialBoxPlotDispGrid(self): 
        self.params = {'axes.labelsize':20,'xtick.labelsize':20,
            'ytick.labelsize':20, 'text.usetex': False,'font.size': 20}
        p.rcParams.update(self.params) 
